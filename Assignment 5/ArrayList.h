...
//    Updates: BinarySearchDescRec and BinarySearchAscRec for searching in descending and
//    ascending order.
//    voidprint(ostream &out) const for printing in a file. 2 remove functions for
//    removing value and range of values.
//
//*****************************************************************************************************
